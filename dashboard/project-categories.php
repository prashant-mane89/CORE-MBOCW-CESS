...
<head>
  ...
  <title>MBOCWCESS Portal | Project Categories</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Project Categories</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <a href="add-project-categories.php" class="btn btn-primary" ><i class="fas fa-plus"></i> Add Project Category</a> 
            ...
            <div class="card-body">
                ...
                <table id="example1" class="table table-bordered">
                    ...
                    <tbody>
                        <?php
                        $sql = "SELECT id, name, description, is_active FROM project_categories ORDER BY name ASC";
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            ...
                            echo "<tr><td colspan='4' class='text-center'>No project category found</td></tr>";
                        }
                        ?>
                    </tbody>
                </table>
...
<script>
    ...
    $(document).on('change', '#activeToggle', function() {
        ...
        $.ajax({
            url: "toggle-project-category.php",
            type: "POST",
