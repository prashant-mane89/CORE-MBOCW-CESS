...
<head>
  ...
  <title>MBOCWCESS Portal | Project Types</title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Project Types</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="card-header">
                <h3 class="card-title">Project Types</h3>
                <div class="card-tools">
                    <a href="add-project-type.php" class="btn btn-primary" ><i class="fas fa-plus"></i> Add Project Type</a> 
